...
def generate_launch_description():
    """
    Precision lookahead P1-P4 marking rover bringup.

    This launch never arms PX4 and never changes the PX4 mode.
    Manual radio control remains available through PX4 MANUAL mode.
    """
    ...
    mission_manager = TimerAction(
        period=11.0,
        actions=[
            LogInfo(msg="Starting lookahead mission_manager"),
            Node(
                ...
                parameters=[{
                    ...
                    "pass_through_lookahead_distance_m": 0.60,
    ...
    rpp_controller = TimerAction(
        period=12.0,
        actions=[
            LogInfo(msg="Starting precision lookahead RPP"),
            Node(
                ...
                parameters=[{
                    ...
                    "marking_near_speed_mps": 0.06,
                    "marking_near_distance_m": 0.15,
                    "pivot_vector_speed_mps": 0.2,
                    "slow_heading_error_deg": 20.0,
                    "pivot_enter_angle_deg": 45.0,
                    "pivot_exit_angle_deg": 5.0,
                    "marking_alignment_pivot_deg": 15.0,
                    "pivot_hold_sec": 0.75,
                    "marking_alignment_distance_m": 0.75,
                    "marking_no_pivot_distance_m": 0.50,
                    "final_bearing_lock_distance_m": 0.25,
                    "final_bearing_lock_error_deg": 5.0,
