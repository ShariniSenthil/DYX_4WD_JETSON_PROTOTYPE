...
class RPPController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("marking_alignment_distance_m", 1.0)
        self.declare_parameter("marking_no_pivot_distance_m", 0.50)
        self.declare_parameter("final_bearing_lock_distance_m", 0.3)
        self.declare_parameter("final_bearing_lock_error_deg", 8.0)
