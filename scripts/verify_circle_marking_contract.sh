...
[[ "$mode" == *"RADIAL_2D"* ]] || fail "marking_error_mode: $mode"
...
echo "PASS marking_error_mode=RADIAL_2D"
echo "PASS circular waypoint radius=30 mm"
echo "PASS stationary hold=3.0 s at <=10 mm/s"
echo "PASS normal speed=0.40 m/s"
echo "PASS interpolation spacing=50 mm"
echo
echo "CIRCULAR 30MM WAYPOINT CONTRACT VERIFIED"